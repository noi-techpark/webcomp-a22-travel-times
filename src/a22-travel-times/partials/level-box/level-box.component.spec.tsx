...
describe.skip('noi-traffic-level-box', () => {
  it('regular: render title and class', async () => {
    const page = await newSpecPage({
      components: [LevelBoxComponent],
      template: () => (<noi-traffic-level-box level="1"></noi-traffic-level-box>),
    });
  ...
  it('severe: render title and class', async () => {
    const page = await newSpecPage({
      components: [LevelBoxComponent],
      template: () => (<noi-traffic-level-box level="2"></noi-traffic-level-box>),
    });
  ...
  it('heavy: render title and class', async () => {
    const page = await newSpecPage({
      components: [LevelBoxComponent],
      template: () => (<noi-traffic-level-box level="3"></noi-traffic-level-box>),
    });
